...
export default function Farm() {
  ...
  const getDataFarm = async () => {
    ...
    // // ini get data langsung dari blockchain
    // if(data.length == 0) {
    ...
    // }
    // // end get data langsung dari blockchain
        ...
        arr.push(
          {
            ...
            "latitude_longitude" : `${value.latitude} - ${value.longitude}`,
            "elevation" : `${value.elevation} MASL`,
